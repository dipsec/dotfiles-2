...
beautiful.init('/home/chris/.config/awesome/theme/theme.lua')
...
-- prevents a process from being started multiple times.
-- See: http://awesome.naquadah.org/wiki/Autostart#Simple_way
